...
console.log('svtyjuhgfdfghnnybtvrcvbnumhngbfvdbgnh')
const getProfile= async()=>{
  ...
  for(var i=0;i<data.results.length;i++){
    ...
    <li class="col-sm-6">
      <div class="media"> 
        <!-- Media Image -->
        <div class="media-left media-middle"> <a href="{% url 'product:product' sc.slug %}" class="item-img"> <img class="media-object" src="${data.results[i].get_main_img}" alt=""> </a> </div>
    ...
    <!-- REMOVE -->
    <li class="col-sm-1">
      <div class="position-center-center" id="remove-product"> <a href="" id="remove-product"><i class="icon-close" id="remove-product"></i></a> </div>
    </li>
    </ul>
    `
  }
...
dltFromCart.addEventListener("click", async (e)=>{
  console.log(e.document.getElementById("remove-product").value);

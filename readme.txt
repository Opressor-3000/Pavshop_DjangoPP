...
git add . && git commit -m 'fix over more -_- ' && git push origin yusif && git checkout dev && git pull origin dev && git merge yusif && git push origin dev && git checkout yusif

...
git add . && git commit -m 'fix filter js / add form reviews ' && git push origin yusif && git checkout dev && git pull origin dev && git merge yusif && git push origin dev && git checkout yusif

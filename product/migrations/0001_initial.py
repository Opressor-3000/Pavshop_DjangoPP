    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=100, unique=True, verbose_name='Brand_slug')),
            ],
            options={
                'verbose_name': 'brand',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=100, unique=True, verbose_name='Collection_slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.collection')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=100, unique=True, verbose_name='Style_slug')),
            ],
            options={
                'verbose_name': 'style',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_id', models.ManyToManyField(to='product.image')),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.product')),
                ('unit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='product.unit')),
            ],
            options={

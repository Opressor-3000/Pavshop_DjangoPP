    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='creater')),
            ],
            options={
                'verbose_name': 'post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, parent_link='parents', related_name='parents', to='product.variant')),
        ...
        migrations.AddField(
            model_name='product',
            name='tag',
            field=models.ManyToManyField(related_name='product_tag', to='product.tag'),
        ),
        migrations.AddField(
            model_name='product',
            name='user',
